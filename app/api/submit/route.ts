...
export async function POST(request: Request) {
  try {
    ...
    try {
      const GF_CREDENTIAL_ID = process.env.GOFUNNEL_WEBHOOK_CREDENTIAL_ID || "7c6d1dd1-7f51-4b41-bff2-fd44d7adc413"
      const GF_BEARER = process.env.GOFUNNEL_WEBHOOK_SECRET || "aacf9e4b-58e8-4bdd-bc43-9b057d4e5b35"
      if (GF_CREDENTIAL_ID && GF_BEARER) {
        ...
        const gfPayload = {
          ...
          sid: gfSid || undefined,
          formId: "aspire-home-solutions-survey",
          formTitle: "Aspire Home Solutions Survey",
